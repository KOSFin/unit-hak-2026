...
export default function ShareModal({ board, onClose }) {
  ...
  return (
    <Modal title={t('shareBoard', language)} onClose={onClose} footer={
      <div className={styles.footer}>
        <Button onClick={onClose} variant="ghost">{t('close', language)}</Button>
      </div>
    }>
      <div className={styles.content}>
        ...
        <div className={styles.linkRow}>
          ...
          <Button onClick={handleCopy} className={styles.iconButton} aria-label={t('copyBoardLink', language)}>
