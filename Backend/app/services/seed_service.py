...
SEED_RULES = [
    {
        ...
        "enabled": True,
        "trigger_type": "task.tag",
        "condition": {"tag": "urgent"},
        "action": {"set_priority": "HIGH", "notify": "Task marked urgent"},
    },
    {
        "name": "Auto progress tag",
        "enabled": True,
        "trigger_type": "task.tag",
        "condition": {"tag": "auto-progress"},
        "action": {"move_to": "In Progress", "notify": "Task moved to In Progress"},
    },
    {
        "name": "Deadline soon flag",
        "enabled": True,
        "trigger_type": "task.deadline",
        "condition": {"hours_lt": 24},
